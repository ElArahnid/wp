...
= 1.8 =
  ...
  * Added tittle font Size Setting.
  * Added tagline font Size Setting.
...
= 1.9 =
  ...
  * Added on off setting for search option. 
  * Added show hide setting for Timing  Section.
  * Added show hide setting for Services  Section. 
...
= 4.1 =
  ...
  * Updated global color css.
  * Changed theme bundle count.
...
= 4.9 =   
  * Updated theme bundle count.
  * Chaned theme notice css.
  * Changed get started css.
...
= 5.6 =
    * Fixed `fitness_exercise_hub_scripts()` function:
      - Corrected multiple `wp_add_inline_style()` calls with proper handle and CSS parameters.
      - Removed unused `$fitness_exercise_hub_menu_font_family` variable.
...
Fitness Exercise Hub WordPress Theme is derived from Twenty Seventeen WordPress Theme, Copyright 2016 WordPress.org
...
Fitness Exercise Hub bundles the following third-party resources:
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/male-running-CWEIEU4MOS