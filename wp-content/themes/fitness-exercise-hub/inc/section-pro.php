 ...
 * @access public
 */
class Fitness_Exercise_Hub_Customize_Section_Pro extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'fitness-exercise-hub';
...
class Fitness_Exercise_Hub_Button extends WP_Customize_Section {
